        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompeleteAt = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonProcesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonProcesses_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonProcesses_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProcesses_LessonId",
                table: "LessonProcesses",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonProcesses_StudentId",
                table: "LessonProcesses",
                column: "StudentId");
